...
const newCategory = async () => {
  ...
  if (result.ok) {
    ...
    categoryCopy.value = resp.category;
    selectedCategory.value = resp.category.id;
  }
};
              ...
              <tr>
                ...
                <td>
                  <div class="input-group">
                    <input id="withdrawNote" class="form-control" type="text" maxlength="128" v-model="categoryCopy.name"/>
