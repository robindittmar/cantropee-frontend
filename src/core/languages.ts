...
export const languages: {[languageCode: string]: Translation} = {
    'en-us': {
        ...
        explainOrganizations: 'An "organization" is like your usual bank account, except it does not contain any actual money. All transations are only visible within the application and do not affect real money. Each transaction is attached to an organization. Once logged in you may create as many organizations as you like and also add family/friends to them, so you can collaboratively track spendings.',
